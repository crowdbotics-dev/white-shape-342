"""
Django settings for white_shape_342 project.
...
ROOT_URLCONF = 'white_shape_342.urls'
...
WSGI_APPLICATION = 'white_shape_342.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "white_shape_342 API",
    "DESCRIPTION": "API documentation for white_shape_342 App",
    "VERSION": "v1",
}
